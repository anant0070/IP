            ...
            <div className="w-10/12 lg:w-1/3 h-11/12 lg:h-4/5 flex-col justify-center items-center bg-white shadow-2xl rounded-md py-12 px-3">
                ...
                <Link href="/auth/login">
                    <div className='w-fit mx-auto cursor-pointer'>
                        ...
                        <p className='text-center text-xl text-[#8D448B] font-poppins font-bold'>Already have an account?</p>
                    </div>
                </Link>
                ...
                <div className='w-10/12 mt-5 mx-auto'>
                    ...
                    <div className='grid grid-cols-1 lg:grid-cols-2 gap-y-1 mt-3'>
                        <div className={`py-1 px-3 border-2 w-fit rounded-full ${password.length>=8?'border-green-500 text-green-500 bg-green-200':'border-gray-500 text-gray-500 bg-gray-100'}`}><TiTick className='inline-block' />8 characters long</div>
                        <div className={`py-1 px-3 border-2 w-fit rounded-full ${password.search(/[A-Z]/)>-1?'border-green-500 text-green-500 bg-green-200':'border-gray-500 text-gray-500 bg-gray-100'}`}><TiTick className='inline-block' />1 Uppercase character</div>
                        <div className={`py-1 px-3 border-2 w-fit rounded-full ${password.search(/[!@#$%^&*]/)>-1?'border-green-500 text-green-500 bg-green-200':'border-gray-500 text-gray-500 bg-gray-100'}`}><TiTick className='inline-block' />1 Special character</div>
                        <div className={`py-1 px-3 border-2 w-fit rounded-full ${password.search(/[0-9]/)>-1?'border-green-500 text-green-500 bg-green-200':'border-gray-500 text-gray-500 bg-gray-100'}`}><TiTick className='inline-block' />1 Number</div>
                    </div>
